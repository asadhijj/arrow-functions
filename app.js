...
// TODO: Uncomment the following line of code to see the output in the browser console
 ...
 const arrowSum = (a,b,c,d) => a+b+c+d;
...
//arrow function for the above function === // 
const arrowObjectLit = () => ({key1 : 'value1', key2 : 'value2', key3 : 'value3'})
...
// this in  joe.scope() gave the values of the object joe
// 2. What is "this" when joe.scopeArrow() is invoked?
// this in joe.scopeArrow() gave the whole scope of the whole javascript window
// 3. Explain why "this" is different when an arrow function is used.
// this in the arrow function behaves differently because it depends on the scopes surrounding it which can to it working or just give the context of the whole window